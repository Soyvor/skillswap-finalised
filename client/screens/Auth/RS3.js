    ...
    <View className="bg-white h-full w-full">
      ...
      <View className="h-full w-full flex justify-around pt-10 pb-10">
        <View className="flex items-center">
          <Animated.Text entering={FadeIn.duration(1000).springify()} className="text-white font-bold tracking-wider text-5xl">Media Upload
        </Animated.Text>
        </View>
        ...
        <View className="flex items-center mx-4 space-y-1">
          <Animated.View entering={FadeInDown.delay(300).duration(1000).springify()} className="bg-black/5 p-3 rounded-2xl w-full mb-1">
            <TextInput defaultValue='' onChangeText={newText => setDescription(newText)} placeholder='Description' placeholderTextColor={'gray'}/>
          ...
          <Animated.View entering={FadeInDown.delay(500).duration(1000).springify()}  className="bg-black/5 p-3 rounded-2xl w-full mb-1">
            <TextInput defaultValue='' onChangeText={newText => setPhotos(newText)} placeholder='Photos' placeholderTextColor={'gray'} />
          </Animated.View>
          <Animated.View entering={FadeInDown.delay(700).duration(1000).springify()}  className="bg-black/5 p-3 rounded-2xl w-full mb-1">
            <TextInput defaultValue='' onChangeText={newText => setVideos(newText)} placeholder='Videos' placeholderTextColor={'gray'} />
          </Animated.View>
          <Animated.View entering={FadeInDown.delay(900).duration(1000).springify()} className="w-full">
             <TouchableOpacity onPress={handleLoginPress} style={styles.loginButton} className="w-full bg-sky-500 p-3 rounded-2xl mb-3 ">
              <Animated.Text entering={FadeInDown.delay(900).duration(1000).springify()}  className="text-xl font-bold text-white text-center ">Complete Registration</Animated.Text>
             </TouchableOpacity>
          </Animated.View>
